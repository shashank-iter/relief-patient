...
export default function RequestDetailsPage({ requestData }) {
  ...
  const handleFinalizeHospital = async (hospitalId, hospitalName) => {
    ...
    try {
      ...
      //   toast({
      //     title: "Hospital Finalized",
      //     description: ${hospitalName} has been finalized for this emergency request.,
      //   })
      ...
      toast({
        title: "Error",
        description: "Failed to finalize hospital. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
  ...
  const handleCancelRequest = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "The emergency request has been cancelled successfully.",
      });
